...
const ROLE_SKILL_SETS: Partial<Record<string, SkillPool>> = {
  ...
  Fixer: {
    points: 86, min: 2, max: 6, default: 4,
    skills: [
      'Athletics', 'Brawling', 'Bribery', 'Business', 'Concentration', 'Conversation',
      'Education', 'Evasion', 'First Aid', 'Forgery', 'Handgun', 'Human Perception',
      'Language (Streetslang)', 'Local Expert (Your Home)', 'Perception', 'Persuasion',
...
const ROLE_EQUIPMENT: Partial<Record<string, EquipmentPackage>> = {
  ...
  Media: {
    fixed: [
      ...
      { name: 'Binoculars', type: 'gear' },
      { name: 'Flashlight', type: 'gear' },
      { name: 'Computer', type: 'gear' },
      { name: 'Video Camera', type: 'gear' },
      { name: 'Radio Scanner/Music Player', type: 'gear' },
      { name: 'Scrambler/Descrambler', type: 'gear' },
      { name: 'Media Outfit (Generic Chic Bottoms/Top/Footwear, Leisurewear Jacket, Urban Flash Mirrorshades)', type: 'gear' },
      { name: 'Cyberaudio Suite', type: 'cyberware' },
      { name: 'Light Tattoo', type: 'cyberware' },
    ],
    choices: [
      { options: [{ name: 'Heavy Pistol', type: 'weapon', damage: '3d6', isRanged: true, handsReq: 1 }, { name: 'Very Heavy Pistol', type: 'weapon', damage: '4d6', isRanged: true, handsReq: 1 }] },
      { options: [{ name: 'Basic H Pistol Ammunition x50', type: 'gear' }, { name: 'Basic VH Pistol Ammunition x50', type: 'gear' }] },
      { options: [{ name: 'Disposable Cell Phone x2', type: 'gear' }, { name: 'Grapple Gun', type: 'gear' }] },
      { options: [{ name: 'Amplified Hearing', type: 'cyberware' }, { name: 'Voice Stress Analyzer', type: 'cyberware' }] },
    ],
  },
  Medtech: {
    fixed: [
      { name: 'Smoke Grenade x2', type: 'gear' },
      { name: 'Light Armorjack', type: 'armor', headSp: 11, bodySp: 11 },
      { name: 'Bulletproof Shield', type: 'gear' },
      { name: 'Agent', type: 'gear' },
      { name: 'Airhypo', type: 'gear' },
      { name: 'Handcuffs', type: 'gear' },
      { name: 'Flashlight', type: 'gear' },
      { name: 'Glow Paint', type: 'gear' },
      { name: 'Medtech Bag', type: 'gear' },
      { name: 'Medtech Outfit (Generic Chic Jacket, Leisurewear Footwear/Bottoms/Top)', type: 'gear' },
      { name: 'Biomonitor', type: 'cyberware' },
      { name: 'Cybereye', type: 'cyberware' },
      { name: 'TeleOptics', type: 'cyberware' },
    ],
    choices: [
      ...
      { options: [{ name: 'Incendiary Shotgun Shell Ammunition x10', type: 'gear' }, { name: 'Incendiary Rifle Ammunition x10', type: 'gear' }] },
      { options: [{ name: 'Nasal Filters', type: 'cyberware' }, { name: 'Toxin Binders', type: 'cyberware' }] },
    ],
  },
  Netrunner: {
    fixed: [
      ...
      { name: 'Light Armorjack', type: 'armor', headSp: 11, bodySp: 11 },
      { name: 'Agent', type: 'gear' },
      { name: 'Cyberdeck (Standard Quality)', type: 'gear' },
      { name: 'Virtuality Goggles', type: 'gear' },
      { name: 'Program: Sword', type: 'gear' },
      { name: 'Program: Armor', type: 'gear' },
      { name: 'Netrunner Outfit (Generic Chic Top, Leisurewear Footwear/Jewelry/Bottoms, Urban Flash Jacket)', type: 'gear' },
      { name: 'Interface Plugs', type: 'cyberware' },
      { name: 'Neural Link', type: 'cyberware' },
      { name: 'Shift Tacts', type: 'cyberware' },
    ],
    choices: [
      { options: [{ name: 'Program: See Ya', type: 'gear' }, { name: 'Program: Eraser', type: 'gear' }] },
      { options: [{ name: 'Program: Sword', type: 'gear' }, { name: 'Program: Vrizzbolt', type: 'gear' }] },
      { options: [{ name: 'Program: Worm', type: 'gear' }, { name: 'Program: Sword', type: 'gear' }] },
    ],
  },
  Nomad: {
    fixed: [
      ...
      { name: 'Duct Tape', type: 'gear' },
      { name: 'Flashlight', type: 'gear' },
      { name: 'Grapple Gun', type: 'gear' },
      { name: 'Inflatable Bed & Sleep-bag', type: 'gear' },
      { name: 'Medtech Bag', type: 'gear' },
      { name: 'Radio Communicator x2', type: 'gear' },
      { name: 'Rope (60m/yds)', type: 'gear' },
      { name: 'Techtool', type: 'gear' },
      { name: 'Tent & Camping Equipment', type: 'gear' },
      { name: 'Nomad Outfit (Bohemian Jewelry, Nomad Leathers Top/Bottoms/Footwear/Jacket/Hat)', type: 'gear' },
      { name: 'Neural Link', type: 'cyberware' },
    ],
    choices: [
      { options: [{ name: 'Heavy Pistol', type: 'weapon', damage: '3d6', isRanged: true, handsReq: 1 }, { name: 'Very Heavy Pistol', type: 'weapon', damage: '4d6', isRanged: true, handsReq: 1 }] },
      { options: [{ name: 'Basic H Pistol Ammunition x100', type: 'gear' }, { name: 'Basic VH Pistol Ammunition x100', type: 'gear' }] },
      { options: [{ name: 'Heavy Melee Weapon', type: 'weapon', damage: '3d6', isRanged: false, handsReq: 1 }, { name: 'Heavy Pistol', type: 'weapon', damage: '3d6', isRanged: true, handsReq: 1 }] },
...
function readCharacterBuilderDossier(): { role: string; bio: string; lifepath: Record<string, string> } | null {
  try {
    ...
    // Character Builder only requires Role to be answered — everything
    // else is optional, so that's all this bridge requires too.
